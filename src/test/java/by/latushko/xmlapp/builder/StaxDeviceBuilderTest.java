...
import static by.latushko.xmlapp.factory.BuilderFactory.TypeParser.SAX;
import static by.latushko.xmlapp.factory.BuilderFactory.TypeParser.STAX;
...
public class StaxDeviceBuilderTest {
    ...
    public void setUp() {
        try {
            builder = BuilderFactory.createDeviceBuilder(STAX);
